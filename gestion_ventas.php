...
<main class="main">
    <h1>GESTION DE VENTAS</h1><br>
    <section class="divi">
        <table>
            <tr>
                <th colspan="6"><h3>VENTAS</h3><br/></th>
            </tr>
            <tr>
                <th>ID Venta</th>
                <th>ID Cliente</th>
    ...
    <section  class="divi"  >
        <table>
            ...
            <tr>
                <td colspan="6"><a class="agregar" href="gestion_ventas.php?btn-insertar-venta=<?php echo $granTotalfinal;?>">Comprar</a><label>  </label><a class="borrar" href="gestion_ventas.php?btn-borrar-venta">Cancelar</a></td>
                    ...
                    foreach($_SESSION["carrito"] as $producto => $arreglo){
                        ...
                        if ($r){
                            ...
                            while($rn= mysqli_fetch_array($r)){
                                ...
                                if ($r){
                                    unset($_SESSION['carrito']);
                                    echo "<script>alert('Compra exitosa!');location.assign('gestion_ventas.php');</script>";
                                }
                            }
                        }
                    }
